...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AI = __webpack_require__(171);
	...
	var App = function (_React$Component) {
	    ...
	    function App() {
	        ...
	        _this.getAiMove = _this.getAiMove.bind(_this);
	    ...
	    _createClass(App, [{
	        ...
	        value: function getAiMove() {
	            ...
	            _superagent2.default.get('/api/num').query({ board: this.state.board.join(',') }).query({ depth: true }).end(function (err, res) {
	                if (err) throw err;
	                _this2.makeMove(res.body.move);
	            });
	        }
	    }, {
	        key: 'updateGameState',
	...
	(0, _reactDom.render)(_react2.default.createElement(App, null), document.getElementById("app-view"));
	    ...
	    _createClass(Board, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'div',
	                { className: 'board' },
	                this.props.board.map(function (cell, index) {
	                    return _react2.default.createElement(_Cell2.default, { key: index, value: cell, index: index, handleClick: _this2.props.onCellClick });
	                })
	            );
	        }
	    }]);
	...
	var Cell = function (_React$Component) {
	    ...
	    _createClass(Cell, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                { className: 'cell', onClick: this.handleClick.bind(this) },
...
/***/ function(module, exports) {
	...
	var MinimaxAI = exports.MinimaxAI = function () {
	    function MinimaxAI(piece) {
	        _classCallCheck(this, MinimaxAI);
	    ...
	    _createClass(MinimaxAI, [{
	        key: 'getMove',
	        value: function getMove(game) {
	            this.minimax(game);
	            return this.CHOICE;
	        }
	    }, {
	        ...
	        value: function minimax(game) {
	            ...
	            if (game.activeTurn === this.PLAYER) {
	                ...
	                var minScore = scores.reduce(function (a, b) {
	                    return Math.min(a, b);
	                });
	...
	var DepthMinimaxAI = exports.DepthMinimaxAI = function (_MinimaxAI) {
	    _inherits(DepthMinimaxAI, _MinimaxAI);

	    function DepthMinimaxAI(piece) {
	        _classCallCheck(this, DepthMinimaxAI);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(DepthMinimaxAI).call(this, piece));
	    }

	    _createClass(DepthMinimaxAI, [{
	        key: 'getMove',
	        value: function getMove(game) {
	            this.minimax(game, 0);
	            return this.CHOICE;
	        ...
	        key: 'score',
	        value: function score(game, depth) {
	            if (game.win(this.PLAYER)) {
	                return 10 - depth;
	            } else if (game.win(this.OPPONENT)) {
	                return depth - 10;
	        ...
	        key: 'minimax',
	        value: function minimax(game, depth) {
	            if (game.over()) {
	    ...
	    return DepthMinimaxAI;
	}(MinimaxAI);

	var Game = function () {
	    function Game(activeTurn, boardArray) {
	    ...
	    _createClass(Game, [{
	        ...
	        value: function move(_move) {
	            this.boardArray[_move] = this.activeTurn;
	        ...
	        key: 'getNewState',
	        value: function getNewState(move) {
	        ...
	        key: 'win',
	        value: function win(piece) {
	            return this.checkRows(piece) || this.checkCols(piece) || this.checkDiags(piece);
	        }
	    }, {
	        key: 'checkRows',
	        value: function checkRows(piece) {
	            return this.boardArray[0] === piece && this.boardArray[1] === piece && this.boardArray[2] === piece || this.boardArray[3] === piece && this.boardArray[4] === piece && this.boardArray[5] === piece || this.boardArray[6] === piece && this.boardArray[7] === piece && this.boardArray[8] === piece;
	        }
	    }, {
	        key: 'checkCols',
	        value: function checkCols(piece) {
	            return this.boardArray[0] === piece && this.boardArray[3] === piece && this.boardArray[6] === piece || this.boardArray[1] === piece && this.boardArray[4] === piece && this.boardArray[7] === piece || this.boardArray[2] === piece && this.boardArray[5] === piece && this.boardArray[8] === piece;
	        }
	    }, {
	        key: 'checkDiags',
	        value: function checkDiags(piece) {
	            return this.boardArray[0] === piece && this.boardArray[4] === piece && this.boardArray[8] === piece || this.boardArray[2] === piece && this.boardArray[4] === piece && this.boardArray[6] === piece;
	        }
	    }]);
